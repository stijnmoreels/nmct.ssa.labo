...
namespace nmct.ssa.labo.webshop.Controllers
{
    public class DeviceController : Controller, IControllerService
    {
        ...
        {
            _vm.FrameWorks = new SelectList(Service.GetFrameworks(), "Id", "Name");
            _vm.Os = new SelectList(Service.GetOs(), "Id", "Name");
        ...
        {
            vm.FrameWorks = new SelectList(Service.GetFrameworks(), "Id", "Name");
            vm.Os = new SelectList(Service.GetOs(), "Id", "Name");
        ...
        public RedirectToRouteResult Create(CreateDeviceVM vm)
        {
            ...
            else
            {
                ...
                var lists = new HandleLists.HandleLists(Service);
                ...
                Service.InsertDevice(_vm.Device);
        ...
        {
            FrameWork frame = Service.GetFrameWorkById(vm.SelectedFrameId);
            var lists = new HandleLists.HandleLists(Service);
        ...
        {
            OS os = Service.GetOsById(vm.SelectedOsId);
            var lists = new HandleLists.HandleLists(Service);
